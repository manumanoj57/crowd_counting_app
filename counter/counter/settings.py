...
SECRET_KEY = 'django-insecure-y&sx!1pm_q6)j9y@03%tmj!rr)cp3^l(v2#u2=kj=!q3-69coi'
...
INSTALLED_APPS = [
    ...
    'crowd_detection',  # Our ML app
    'channels',  # WebSockets for real-time streaming
...
CHANNEL_LAYERS = {
    "default": {
        "BACKEND": "channels.layers.InMemoryChannelLayer",  # In-memory for now, Redis later
    },
}
